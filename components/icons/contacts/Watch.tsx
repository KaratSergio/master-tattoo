export const Watch = ({ className }: { className: string }) => {
    return (
        <svg
            className={className}
        ...
        >
            <path
                ...
                fill="url(#paint0_linear_393_5650)"
            />
            <path
                ...
                fill="url(#paint1_linear_393_5650)"
            />
            <defs>
                <linearGradient
                    id="paint0_linear_393_5650"
                    x1="12"
                    y1="0"
                    x2="12"
                    y2="24"
